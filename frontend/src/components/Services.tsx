  ...
  const handleClick = (e: React.MouseEvent<HTMLAnchorElement>) => {
    if (!isAuthenticated) {
      ...
      navigate("/Signin", {
        state: {
          success:
            "Please Signin to use our services or Signup If you don't have an account",
        },
      });
    }
  };
...
const Services: React.FC<ServiceCardProps> = ({ isAuthenticated }) => {
  const services = [
    ...
    },
    {
      ...
      title: "AI Assistant",
      description:
        "Our intelligent chatbot offers immediate support, answers questions about your carbon footprint, and suggests optimization strategies.",
      gradient: "bg-gradient-to-r from-blue-500 to-blue-600",
      link: "/ai-assistant",
    },
    {
      icon: (
        <BarChart4 className="text-teal-600 dark:text-teal-400" size={32} />
      ),
      title: "Gas Forecasting",
      description:
        "Leverage the power of AI to predict future emissions based on various scenarios, helping you make informed decisions and set realistic targets.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="mt-6 text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            CARBONSENS offers a comprehensive suite of tools to monitor,
            analyze, and optimize your carbon footprint through cutting-edge IoT
            and AI technologies.
          </p>
        </div>
              ...
              <div className="grid md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-200 dark:divide-gray-700">
                <div className="p-6">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm">
                    IoT sensors capture real-time carbon emission data from
                    various sources.
                  </p>
                </div>
                <div className="p-6">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm">
                    Advanced algorithms analyze patterns and identify
